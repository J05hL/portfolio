...
const homeP1 = `I am a recent graduate from the School of Code where I have spent the last four months on an intensive bootcamp studying 
...
const homeP2 = `The first of these being a one week project in a team of four and the second a one month project in a team of six. Both of 
...
const homeP3 = `These last four months have imparted on me a love of React and Node.js and I enjoy logically breaking down problems and 
planning out the flow of state or how a function needs to behave to return the desired result.`

const homeP4 = `I am now looking for my first junior role in this sector and hope to continue this journey and continue building on 

...
const ylfbTitle = `Your Local Food Bank`

const ylfbP1 = `Your Local Food Bank was our final project for School of Code. As a team of six we decided to build an application that 
would assist small food banks in better communication with their communities. We decided on 3 main users, the beneficiary, the volunteer and the 
food bank manager. Once we had established the user personas we identified a number of user stories to zero in on the problems we would solve 
...
the accordions are two examples of this. We also built map a feature which used a Google Maps API to better display information on the location of 
the food bank displayed.`
...
We again made the decision to use a technology we were not familiar with for our database to experiment and further our knowledge. We also built 
a CMS for a food bank manager to log in and edit details for their food bank.` 
...
const ylfbLinks = [
  {name: `Our deployed site`, link: deployed},

export const xpTitle = `Experience`

const xpP1 = `At the school of Code we worked in teams to deliver products and complete workshops to cement whatever we had learnt that day.
...
const xpP2 = `The course contained two larger projects. The first of these being a one week project in a team of four and the 
...
const xpP3 = `Before decided to change my career path I have always worked in areas requiring a strong focus on teamwork 
